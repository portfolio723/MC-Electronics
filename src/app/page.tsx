...
const BrandLogos: React.FC<{ brand: string }> = ({ brand }) => {
    const logos: { [key: string]: React.ReactNode } = {
        Samsung: <svg className="h-8 w-auto text-muted-foreground group-hover:text-accent-foreground" viewBox="0 0 24 24" fill="currentColor"><path d="M21.16,3.33H2.84A2.51,2.51,0,0,0,.33,5.84V18.16a2.51,2.51,0,0,0,2.51,2.51H21.16a2.51,2.51,0,0,0,2.51-2.51V5.84A2.51,2.51,0,0,0,21.16,3.33ZM9.49,16.71a.5.5,0,0,1-.7,0L5.33,13.25v2.9a.5.5,0,0,1-1,0V7.8a.5.5,0,0,1,.7-.4L9,9.85V7.8a.5.5,0,1,1,1,0v8.41A.5.5,0,0,1,9.49,16.71Zm5.44-8.85a.5.5,0,0,1-.5.5H11.23a.5.5,0,0,1,0-1h3.2A.5.5,0,0,1,14.93,7.86Zm3.8,6.8a.51.51,0,0,1-.71.05l-2.9-2.9v2.35a.5.5,0,1,1-1,0V7.8a.5.5,0,0,1,.7-.4L19,9.85V7.8a.5.5,0,1,1,1,0v6.11a.51.51,0,0,1-.27.45Z"/></svg>,
